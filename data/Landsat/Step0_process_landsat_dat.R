...
# Data Source on EDI
# https://portal.edirepository.org/nis/mapbrowse?scope=knb-lter-sbc&identifier=74&revision=34
...
#set directories 
datin <- "/Volumes/enhydra/data/kelp_remote_sensing/landsat/raw"
datout <- "/Volumes/enhydra/data/kelp_remote_sensing/landsat/processed"
figdir <- here::here("analyses","figures")

landsat_dat <- "LandsatKelpBiomass_2026_Q2_withmetadata.nc"
...
################################################################################
#Export
st_write(kelp_landsat_export_MPEN, file.path(datout, "monterey_peninsula/landsat_mpen_1984_2026_points_withNAs.shp"))
