...
#load benthic survey data averaged to zone level
load(file.path(datadir, "MBA_kelp_forest_database/processed/recovery/kelp_recovery_data.rda"))

#load dissection data averaged to zone level
...
lda_patch <- load("/Users/jossmith/code_respositories/kelp_recovery/output/lda_patch_transitionsv6.rda") #need to move this to server
...
################################################################################
#Step 1: prep dissection data by aggregating to zone and species
...
save(quad_build3, file = "/Volumes/enhydra/data/kelp_recovery/MBA_kelp_forest_database/processed/aggregated_data/recovery_zone_level_data.rda") 
